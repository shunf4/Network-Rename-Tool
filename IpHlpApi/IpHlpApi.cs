...
namespace Vanara.PInvoke
{
	...
	public static partial class IpHlpApi
	{
		...
		public struct HIFTIMESTAMPCHANGE : IHandle
		{
			...
			public static HIFTIMESTAMPCHANGE NULL => new HIFTIMESTAMPCHANGE(IntPtr.Zero);
			...
			/// <returns>The result of the conversion.</returns>
			public static implicit operator HIFTIMESTAMPCHANGE(IntPtr h) => new HIFTIMESTAMPCHANGE(h);
